...
export const SYLLABUS: Subject[] = [
  {
    ...
    units: [
      { id: "hist-anc", title: "प्राचीन एवं मध्यकालीन इतिहास", topics: [
        ...
        t("hist-anc-10", "राजस्थान के राजवंशों की प्रशासनिक व राजस्व व्यवस्था"),
      ]},
      ...
      { id: "hist-nat", title: "भारतीय राष्ट्रीय आन्दोलन", topics: [
        t("hist-nat-1", "19वीं व 20वीं शताब्दी में भारत के सामाजिक एवं धार्मिक सुधार आंदोलन"),
        t("hist-nat-2", "भारतीय स्वतंत्रता आंदोलन की विभिन्न अवस्थाएँ व विभिन्न क्षेत्रों के योगदानकर्ता"),
        t("hist-nat-3", "स्वतंत्रयोत्तर राष्ट्र निर्माण — राष्ट्रीय एकीकरण व राज्यों का पुनर्गठन"),
        t("hist-nat-4", "नेहरू युग में सांस्थानिक निर्माण, विज्ञान एवं तकनीकी का विकास"),
      ]},
      { id: "hist-cult", title: "कला, संस्कृति, साहित्य व धरोहर", topics: [
        ...
        t("hist-cult-14", "राजस्थान के प्रमुख व्यक्तित्व"),
      ]},
    ],
  },
  {
    ...
    units: [
      { id: "geo-raj", title: "राजस्थान का भूगोल", topics: [
        ...
        t("geo-raj-18", "पारंपरिक जल संरक्षण तकनीकें — जोहड़, टांका, नाड़ी, खड़ीन"),
      ]},
      { id: "geo-ind", title: "भारत का भूगोल", topics: [
        ...
        t("geo-ind-10", "भारत के वन्य जीव-जन्तु व अभयारण्य"),
      ]},
  ...
  },
  {
    ...
    units: [
      { id: "poli-const", title: "भारतीय संविधान", topics: [
        ...
        t("poli-const-6", "संविधान सभा — गठन व विशेषताएँ"),
        t("poli-const-7", "आपातकालीन प्रावधान"),
        t("poli-const-8", "जनहित याचिका (PIL)"),
      ]},
  ...
  },
  {
    ...
    units: [
      { id: "eco-ind", title: "भारतीय अर्थव्यवस्था", topics: [
        ...
        t("eco-ind-9", "राष्ट्रीय आय"),
        t("eco-ind-10", "सब्सिडी व लोक वितरण प्रणाली"),
        t("eco-ind-11", "ई-कॉमर्स"),
        t("eco-ind-12", "हरित क्रांति, श्वेत क्रांति व नीली क्रांति"),
      ]},
      { id: "eco-raj", title: "राजस्थान की अर्थव्यवस्था", topics: [
        ...
        t("eco-raj-9", "वृहद सिंचाई परियोजनाएँ व इंदिरा गांधी नहर परियोजना"),
        t("eco-raj-10", "मनरेगा (MNREGA) व ग्रामीण रोजगार योजनाएँ"),
        t("eco-raj-11", "सहकारी आंदोलन व वित्तीय संस्थाएँ"),
      ]},
    ],
  },
  {
    ...
    units: [
      ...
      { id: "gs-bio", title: "जीव विज्ञान (Biology)", topics: [
        ...
        t("gs-bio-9", "रक्त समूह व RH कारक"),
      ]},
      ...
      { id: "gs-raj", title: "विज्ञान-प्रौद्योगिकी व कृषि (राजस्थान संदर्भ)", topics: [
        t("gs-raj-1", "कृषि-विज्ञान, उद्यान-विज्ञान, वानिकी व पशुपालन — राजस्थान विशेष संदर्भ"),
        t("gs-raj-2", "विज्ञान एवं प्रौद्योगिकी का विकास — राजस्थान विशेष संदर्भ"),
        t("gs-raj-3", "जन्तुओं व पादपों का आर्थिक महत्व"),
      ]},
    ],
  },
  {
    ...
    units: [
      { id: "reason-verbal", title: "शाब्दिक व अशाब्दिक तर्क", topics: [
        ...
        t("reason-verbal-15", "इनपुट-आउटपुट (Input-Output)"),
        t("reason-verbal-16", "नंबर रैंकिंग व टाइम स्क्वायर"),
        t("reason-verbal-17", "शब्दों का तार्किक क्रम (Logical Arrangement of Words)"),
        t("reason-verbal-18", "निर्णय क्षमता (Making Judgments)"),
      ]},
  ...
  },
  {
    ...
    units: [
      ...
      { id: "eng-comp", title: "Comprehension & Composition", topics: [
        ...
        t("eng-comp-6", "Translation — Hindi to English & English to Hindi"),
        t("eng-comp-7", "Glossary of Official/Technical Terms"),
      ]},
    ],
  },
  {
    ...
    units: [
      { id: "hin-vyak", title: "व्याकरण", topics: [
        ...
        t("hin-vyak-16", "विराम चिह्न"),
        t("hin-vyak-17", "ध्वनि एवं उसका वर्गीकरण"),
      ]},
      { id: "hin-rach", title: "शब्द रचना व प्रयोग", topics: [
        ...
        t("hin-rach-5", "राजभाषा हिन्दी — संवैधानिक स्थिति"),
      ]},
    ],
  },
  {
